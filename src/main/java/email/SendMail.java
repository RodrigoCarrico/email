...
public class SendMail {
     ...
     */
    public SendMail (String userEmail, String userPassword) { //Para o GMAIL
     ...
     */
    public SendMail (String mailSMTPServer, String mailSMTPServerPort, String userEmail, String userPassword) { //Para outro Servidor
    ...
    public void sendMail(String from, String to, String subject, String message) {
        ...
        auth = new SimpleAuth (userEmail,userPassword);
        ...
        try {
             ...
             */
            tr.connect(mailSMTPServer, userEmail, userPassword);
